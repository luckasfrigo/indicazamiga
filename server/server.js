...
const passportInit = require('./routes/passport')
...
// run the server in https mode locally
  ...
  const certOptions = {
    key: fs.readFileSync(path.resolve('localcert/localhost.key')),
    cert: fs.readFileSync(path.resolve('localcert/localhost.crt'))
  }
